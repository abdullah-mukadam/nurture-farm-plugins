...
export default class CategoricalDeckGLContainer extends React.PureComponent {
  ...
  getLayers(values, isZoomedOut) {
    ...
    // const noData = false; const filteredPayload = {}

    const filteredPayload = isZoomedOut
      ? {
          ...payload,
  ...
  handleZoomedOutState = isZoomedOut => {
    this.setState(prev => ({
      ...prev,
      isZoomedOut,
    }));
    ...
    return (
      <div style={{ position: 'relative' }}>
        <AnimatableDeckGLContainer
          ...
          setZoomState={this.handleZoomedOutState}
          isZoomedOut={this.state.isZoomedOut}
